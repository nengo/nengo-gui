...
import data_to_csv from "./data_to_csv";
...
footer(type, ok_function, cancel_function) {
    ...
    if (type === "close") {
        ...
        $('#confirm_savepdf_button').on('click', function() {
            ...
            var source = '<?xml version="1.0" standalone="no"?>' + svg_xml;
 ...
 */
multiline_plot(selector, x, ys, x_label, y_label) {
...
$( document ).ready(function() {
    var $validator = $.fn.validator.Constructor.DEFAULTS;
