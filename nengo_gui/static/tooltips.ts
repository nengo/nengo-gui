...
export const Ens = {
    ...
    "radius": ["Type: int\nDefault: 1.0",
               ...
               "the ensemble."],
    "encoders": ["Type: Distribution or ndarray (`n_neurons`, " +
    ...
    "intercepts": ["Type: Distribution or ndarray (`n_neurons`)\n" +
    ...
    "max_rates": ["Type: Distribution or ndarray (`n_neurons`)\n" +
                  "Default: Uniform(200, 400)",
                  "The activity of each neuron when dot(x, e) = 1, " +
                  "where e is the neuron's encoder."],
    "eval_points": ["Type: Distribution or ndarray (`n_eval_points`, " +
                    "`dims`)\nDefault: UniformHypersphere()",
...
export const Node = {
    "output": ["Type: callable, array_like, or None",
...
export const Conn = {
    ...
    "fan_passthrough": ["This connection is to / from a passthrough n" +
