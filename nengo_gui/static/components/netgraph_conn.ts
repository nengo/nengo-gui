...
redraw() {
    ...
    if (this.recurrent) {
        ...
        var a1 = Math.atan2(h1, w1);
        var a2 = Math.atan2(h2, w2);
        ...
        var vec1 = [post_pos[0] - pre_pos[0], post_pos[1] - pre_pos[1]];
        var vec2 = [mx - pre_pos[0], my - pre_pos[1]];
        var dot_prod = (vec1[0]*vec2[0] + vec1[1]*vec2[1]) /
